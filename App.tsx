  ...
  <div className="hidden md:flex md:w-1/2 bg-[#1e1e2e] p-12 text-white flex-col justify-between relative overflow-hidden">
    ...
    <div className="absolute top-1/2 right-0 transform translate-x-1/3 -translate-y-1/2 opacity-10 pointer-events-none">
       <svg width="600" height="600" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
         <path fill="#FFFFFF" d="M45.7,-70.5C58.9,-62.5,69.3,-49.4,75.9,-34.7C82.5,-20,85.4,-3.7,82.4,11.5C79.4,26.7,70.6,40.8,59.6,51.8C48.6,62.8,35.4,70.7,21.3,74.5C7.2,78.3,-7.8,78.1,-21.8,73.6C-35.8,69.1,-48.8,60.3,-58.5,48.7C-68.2,37.1,-74.6,22.7,-76.3,7.6C-78,-7.5,-75,-23.3,-66.1,-36.2C-57.2,-49.1,-42.4,-59.1,-27.6,-66.2C-12.8,-73.3,2,-77.5,17.4,-77.1C32.8,-76.7,48.9,-71.7,45.7,-70.5Z" transform="translate(100 100)" />
       </svg>
    </div>
  </div>
);
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value={Role.ORGANIZER}>Penyelenggara (Organizer)</option>
                </select>
...
const AppContent: React.FC = () => {
  return (
    <Routes>
      ...
      <Route path="/events/:id" element={<WithLayout><EventDetails /></WithLayout>} />
